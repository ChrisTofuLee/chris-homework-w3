...
//password shuffler + generator
  const shuffler = criteria.sort(() => 0.5 - Math.random());
  const criteriaString = criteria.toString()
  ...
  /*let shufflePassword = []
      for (let ia = 0; ia < 5; ia++) {
        shufflePassword.push(shuffler[ia])
      }*/
      let shufflePassword = shuffler.slice(0, 6);
      console.log(shuffler)
